...
<div class="dms-card">
    ...
    <div class="dms-toolbar">
        <form action="{{ route('stock.index') }}" method="GET" class="dms-search-form">
        ...
        <div class="dms-toolbar-actions">
            <!-- Filter Stock Status -->
            <select name="stock_status" onchange="window.location.href = this.value" class="form-control">
                ...
                <tr>
                    <td>
                        <div class="dms-identity">
                            ...
                            <div>
                                ...
                                <div class="dms-muted">Rp {{ number_format($product->price, 0, ',', '.') }}</div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="dms-actions">
                            <a href="{{ route('stock.show', $product) }}" class="dms-btn dms-btn-outline dms-btn-sm" title="Detail Stok">
                                <i class="bi bi-eye"></i>
                            </a>
                            @can('create stock movement')
                            <a href="{{ route('stock.add-form', $product) }}" class="dms-btn dms-btn-outline dms-btn-sm" title="Tambah Stok">
                                <i class="bi bi-plus-circle"></i>
                            </a>
                            <a href="{{ route('stock.reduce-form', $product) }}" class="dms-btn dms-btn-outline dms-btn-sm" title="Kurangi Stok">
                                <i class="bi bi-dash-circle"></i>
                            </a>
                            @endcan
                            @can('manage warehouse')
                            <a href="{{ route('stock.adjustment-form', $product) }}" class="dms-btn dms-btn-outline dms-btn-sm" title="Penyesuaian Stok">
