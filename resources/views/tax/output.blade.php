...
<div class="dms-card tax-page">
    <div class="tax-page-header">
        ...
        <div class="tax-actions">
            ...
            @can('create invoice')
                <form action="{{ route('tax.output.mark-exported', request()->query()) }}" method="POST" onsubmit="return confirm('Tandai pajak keluaran sesuai filter saat ini sebagai exported?');">
                    @csrf
    ...
    @can('create invoice')
        <div class="tax-import-panel">
            <div class="tax-import-copy">
                ...
                <span>Import hasil Coretax CSV: invoice_number, tax_status, tax_invoice_number, tax_invoice_date, tax_error_message.</span>
            </div>
