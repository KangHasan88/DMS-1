...
<div class="dms-card">
    <div style="margin-bottom: 2rem;">
        <h3 style="font-size: 1.2rem; font-weight: 600; color: var(--dms-secondary);">Edit Role: {{ ucwords(str_replace('-', ' ', $role->name)) }}</h3>
        <p style="font-size: 0.85rem; color: var(--dms-gray-500);">Ubah nama role dan permissionnya</p>
    </div>
    ...
    <form action="{{ route('roles.update', $role) }}" method="POST" id="editForm">
        @csrf
        @method('PUT')
            ...
            <div>
                <div style="background: var(--dms-gray-50); border-radius: 12px; padding: 1.5rem; border: 1px solid var(--dms-gray-200); position: sticky; top: 2rem;">
                    ...
                    <div class="form-group">
                        ...
                        <div style="margin-top: 0.5rem; color: var(--dms-warning); font-size: 0.75rem;">
                            <i class="bi bi-exclamation-triangle"></i> Nama Super Admin tidak dapat diubah
                        </div>
                        @endif
                    </div>
            ...
            <div>
                <div style="background: var(--dms-gray-50); border-radius: 12px; padding: 1.5rem; border: 1px solid var(--dms-gray-200);">
                    ...
                    <div style="padding: 2rem; text-align: center; background: white; border-radius: 8px; border: 1px dashed var(--dms-warning);">
                        ...
                        <p style="color: var(--dms-gray-500);">Role Super Admin memiliki semua permission secara otomatis. Tidak perlu diatur.</p>
                    </div>
                    @else
