...
class TrialBalanceFlowTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_finance_can_view_balanced_trial_balance(): void
    {
        ...
        $this->actingAs($finance)
            ...
            ->assertSee('Modal Pemilik')
            ->assertSee('Rp 100.000');
    }

    public function test_trial_balance_includes_opening_balance(): void
    {
        $finance = $this->userWithRole('finance');
        $cash = $this->account('1101', 'Kas Operasional', ChartAccount::TYPE_ASSET);
        $capital = $this->account('3101', 'Modal Pemilik', ChartAccount::TYPE_EQUITY);
    ...
    public function test_warehouse_cannot_access_trial_balance(): void
    {
    ...
    public function test_branch_finance_only_sees_scoped_trial_balance_accounts(): void
    {
